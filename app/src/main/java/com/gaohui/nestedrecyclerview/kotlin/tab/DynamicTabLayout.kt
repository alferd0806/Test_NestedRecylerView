...
class DynamicTabLayout @JvmOverloads constructor(context: Context, attrs: AttributeSet? = null, defStyleAttr: Int = 0) :
    ...
    private var mPagerAdapter: androidx.viewpager.widget.PagerAdapter? = null
     ...
     */
    @JvmOverloads
    fun setupWithViewPager(viewPager: androidx.viewpager.widget.ViewPager?, autoRefresh: Boolean = true) {
        setupWithViewPager(viewPager, autoRefresh, false)
    }

    private fun setupWithViewPager(viewPager: androidx.viewpager.widget.ViewPager?, autoRefresh: Boolean,
    ...
    override fun onAttachedToWindow() {
        ...
        if (mViewPager == null) {
            val vp = parent
            if (vp is androidx.viewpager.widget.ViewPager) {
     ...
     * @param addObserver
     */
    fun setPagerAdapter(adapter: androidx.viewpager.widget.PagerAdapter?, addObserver: Boolean) {
     ...
     * @param tabLayout
     */
    class TabLayoutOnPageChangeListener(tabLayout: DynamicTabLayout) : androidx.viewpager.widget.ViewPager.OnPageChangeListener {
        ...
        override fun onPageScrolled(position: Int, positionOffset: Float,
            ...
            if (tabLayout != null) {
                val updateText = mScrollState != androidx.viewpager.widget.ViewPager.SCROLL_STATE_SETTLING ||
                        mPreviousScrollState == androidx.viewpager.widget.ViewPager.SCROLL_STATE_DRAGGING
                val updateIndicator = !(mScrollState == androidx.viewpager.widget.ViewPager.SCROLL_STATE_SETTLING
                        && mPreviousScrollState == androidx.viewpager.widget.ViewPager.SCROLL_STATE_IDLE)
        ...
        override fun onPageSelected(position: Int) {
            ...
            if (tabLayout != null && tabLayout.selectedTabPosition != position && position < tabLayout.tabCount) {
                val updateIndicator = (mScrollState == androidx.viewpager.widget.ViewPager.SCROLL_STATE_IDLE
                        || (mScrollState == androidx.viewpager.widget.ViewPager.SCROLL_STATE_SETTLING
                        && mPreviousScrollState == androidx.viewpager.widget.ViewPager.SCROLL_STATE_IDLE))
         ...
         */
        fun reset() {
            mScrollState = androidx.viewpager.widget.ViewPager.SCROLL_STATE_IDLE
            mPreviousScrollState = mScrollState
        }
     ...
     * @property mViewPager
     */
    class ViewPagerOnTabSelectedListener(private val mViewPager: androidx.viewpager.widget.ViewPager) :
     ...
     */
    private inner class AdapterChangeListener internal constructor() : androidx.viewpager.widget.ViewPager.OnAdapterChangeListener {
        private var mAutoRefresh = false
        override fun onAdapterChanged(viewPager: androidx.viewpager.widget.ViewPager,
                                      oldAdapter: androidx.viewpager.widget.PagerAdapter?, newAdapter: androidx.viewpager.widget.PagerAdapter?) {
