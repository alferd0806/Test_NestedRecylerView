...
import com.gaohui.nestedrecyclerview.kotlin.holder.SimpleCategoryViewHolder
import com.gaohui.nestedrecyclerview.kotlin.holder.SimpleTextViewHolder

class MultiTypeAdapter(private val dataSet: ArrayList<Any>) :
    ...
    override fun onBindViewHolder(holder: RecyclerView.ViewHolder, pos: Int) {
        if (holder is SimpleTextViewHolder) {
            ...
            holder.mTv.setOnClickListener {
                Log.i("zxm", dataSet[pos] as String)
            }
